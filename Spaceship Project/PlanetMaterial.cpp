...
PlanetMaterial::PlanetMaterial(
	...
	const std::string& normal_map_jpg_filename_
	)
	: m_color(color, 1), FilterMode(filter_mode), texture_jpg_filename(texture_jpg_filename_)
{
	...
	if (normal_map_jpg_filename_.length()) {
		normal_map_jpg_filename = normal_map_jpg_filename_;
	}
...
void PlanetMaterial::SetMaterial(const Object * pObject)
{
